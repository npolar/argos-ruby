      ...
      soap.getPlatformList["data"]["program"].each do |program|
        ...
        active.each_with_index do | platform, idx |
          ...
          20.downto(1) do |daysago|
            ...
            year = date.year # Fixes https://github.com/npolar/argos-ruby/issues/6
            ...
            begin
              ...
              log.debug "Day -#{daysago}: #{date} [#{ updating == false ? 'validated and kept existing file' : 'updating'}]: #{new_xml_ng.xpath("//message").size} message(s) (program #{programNumber}, platform #{platformId})"
